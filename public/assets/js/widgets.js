$(function () {
	...
	if (document.querySelector("#w-chart1")) {
	...
	if (document.querySelector("#w-chart2")) {
	...
	if (document.querySelector("#w-chart3")) {
	...
	if (document.querySelector("#w-chart4")) {
	...
	if (document.querySelector("#w-chart5")) {
	...
	if (document.querySelector("#w-chart6")) {
	...
	if (document.querySelector("#w-chart7")) {
	...
	if (document.querySelector("#w-chart8")) {
